...
def timeit(name=None):
    def wrapper2(func):
        def wrapper1(*args, **kargs):
            ...
            print('res:      %s' % r)
            print('err1:    %s' % (50 - Counter(r[: 50]).most_common()[0][1]))
            print('err2:    %s' % (50 - Counter(r[50: 100]).most_common()[0][1]))
            print('err3:    %s' % (50 - Counter(r[100: 150]).most_common()[0][1]))
            print('---------------')
            return r
        return wrapper1
    return wrapper2
...
if __name__ == '__main__':
    # main()
    r = "1234533"
    print(Counter(r[: 50]).most_common())